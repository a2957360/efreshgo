...
import {
  ...
  recipeDetailGetProductFromCart,
} from "../actions/cart";
...
export default function SingleColumnItemList(props) {
  ...
  useEffect(() => {
    ...
    dispatch(recipeDetailGetProductFromCart(data));
  }, []);
  ...
  const renderItem = ({ item, index }) => {
    ...
    return (
      ...
      <View key={item.itemNumber} style={styles.mainContainer}>
    ...
    return (
      <View style={styles.container}>
        ...
        <FlatList
          ...
          ListEmptyComponent={<View>{/* <Text>No product</Text> */}</View>}
        />
      </View>
    );
  }
...
// else if (isAddProductToCartLoading) {
//     return <LoadingScreen />;
//   }
